...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="application/javascript">
        $(function(){
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/proneed/showInfo?mark=0',
                dataType:'json',
...
<form name="form2" action="${pageContext.request.contextPath}/proneed/add" method="post" enctype="multipart/form-data"  id="form3">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input name="title"/>
        <input type="file" name="files" value="上传">
