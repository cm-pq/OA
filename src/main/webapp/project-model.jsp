...
<c:forEach items="${ddl}" var="del" varStatus="i">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="101" class="np"></td>
	<td>${i.count}</td>
	<td align="center"><a href=''><u>${del.modname}</u></a></td>
	<td align="center"><a href=''><u>${del.proNeed.title}</u></a></td>
	<td align="center"><a href=''><u>${del.proNeed.project.pname}</u></a></td>
	<td>${del.level}</td>
	<td>2015-02-03</td>
	<td>2015-06-03</td>
