...
<head>
	...
	<script type="application/javascript">
        $(function () {
            ...
            $.ajax({
                type: 'GET',
                url: '${pageContext.request.contextPath}/so/up',
                ...
                success:function(rs){
                    ...
                    var setting = {
                        ...
                        async: {
                            enable: true,
                            url: "${pageContext.request.contextPath}/so/tree",
...
<form name="form2" action="${pageContext.request.contextPath}/so/updateInfo" id="fomm" method="post">
	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center"
		...
		<tr>
			...
			<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
                ...
                <input type="hidden" id="ioo" name="ids">
