...
<c:forEach items="${emm}" var="es" varStatus="i">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="${es.eid}}" class="np"></td>
	<td>${i.count}</td>
	<td>${es.ename}</td>
	<td align="center">${es.position.name}</td>
	<td>${es.esex==1?"男":"女"}</td>
	<td>${es.eage}</td>
	<td>${es.telephone}</td>
	<td><fmt:formatDate value="${es.hiredate}" pattern="yyyy-MM-dd"></fmt:formatDate> </td>
	<td>正常</td>
