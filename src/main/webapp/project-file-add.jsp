...
<form name="form2" id="form6" action="${pageContext.request.contextPath}/att/add" method="post" enctype="multipart/form-data" >
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22"><input type="file" name="files"/>
