	...
	<script type="application/javascript">
        $(function(){
            var setting = {
                ...
                async: {
                    enable: true,//允许我们远程加载一个树结构(json)
                    url:"${pageContext.request.contextPath}/so/tree",//加载路径
                    autoParam:["id", "name=n", "level=lv"]//设定每个树节点的标记
                },
            };
            //第一个参数表示哪一个标签负责展示树
...
<form name="form2" action="${pageContext.request.contextPath}/so/addRole" method="post" id="form18">
