...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="com" name="comname"  onchange="addcus(this.value)">
			<option>选择公司</option>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text"  id="cp"  readonly="readonly" name="comper"/>
	</td>
...
<td height="28" colspan=4 align=center>
	...
	<a href="${pageContext.request.contextPath}/pro/project-show" class="coolbg">返回</a>
</td>
</tr>
</table>
<script type="text/javascript">
