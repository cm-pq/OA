...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><%= new Date() %></td>
	<td><%= new Date() %></td>
	<td><a href="${pageContext.request.contextPath}/att/download?path=${att.path}">下载</a> |<a href="#">删除</a> |<a href="project-file-edit.jsp">编辑</a> | <a href="project-file-look.jsp">查看详情</a></td>
</tr>
    </c:forEach>
<tr bgcolor="#FAFAF1">
