	...
	<script type="application/javascript">
      ...
      $.ajax({
         ...
         $(object).each(function (index,item) {
             console.log(item);
             $("#type").append("<option value='"+item.etid+"'>"+item.etname+"</option>");
            });
...
<form name="form2" action="${pageContext.request.contextPath}/bao/save" id="form9" method="post">
